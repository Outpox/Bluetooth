...
export const XboxControllerIcon = (props: XboxControllerIconProps = { none: false, partial: false }) => {
  const icon = Object.values(IconsModule).find((mod: any) =>
    mod?.toString && /d:\"M36 24.2C36 27.68 31 30 31 30L25 /.test(mod.toString())
...
export const ArrowIcon = (props: ArrowIconProps) => {
  const icon = Object.values(IconsModule).find((mod: any) =>
    mod?.toString && /d:\"M17.98 26.54L3.20996 11.77H32.75L17.98 26.54Z/.test(mod.toString())
...
export const SettingsIcon = Object.values(IconsModule).find((mod: any) =>
  mod?.toString && /d:\"M33 20.38V15.62L29.07 /.test(mod.toString())
) as FC<SVGAttributes<SVGElement>>;
